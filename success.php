...
try {
    ...
    $source_label = $lead_data['source'] === 'audit' ? 'Free Audit Form' : 'Contact Form';
    $tg = "🔔 <b>New Lead — HariGopinath.com</b>\n\n"
        . "<b>Name:</b> "    . htmlspecialchars($lead_data['name'])    . "\n"
        . "<b>Email:</b> "   . htmlspecialchars($lead_data['email'])   . "\n"
        . "<b>Phone:</b> "   . (htmlspecialchars($lead_data['phone'])  ?: '—') . "\n"
        . "<b>Website:</b> " . (htmlspecialchars($lead_data['website']) ?: '—') . "\n"
        . "<b>Budget:</b> "  . (htmlspecialchars($lead_data['budget']) ?: '—') . "\n"
        . "<b>Goal:</b> "    . (htmlspecialchars($lead_data['goal'])   ?: '—') . "\n"
        . "<b>Source:</b> "  . $source_label . "\n"
        . "\n<a href=\"https://harigopinath.com/admin/crm.php\">View in CRM →</a>";
    telegram_notify($tg);
